...
void main() {
  ...
  final png = './test/js.png';
  final gif = './test/js.gif';
  final ico = './test/js.ico';
  final jpg = './test/js.jpg';
  ...
  group('Icon output: ', () {
    test('Correctly outputs a standard set from PNG', () async {
      int n = await generateIconSet(png, standardSet);
    ...
    test('Correctly outputs the windows set from JPG', () async {
      int n = await generateIconSet(jpg, w10);
    ...
    test('Correctly outputs a standard set from PNG to ICO', () async {
      int n = await generateIconSet(png, standardSet, extension: 'ico');
    ...
    test('Correctly outputs a custom set from PNG in a subfolder', () async {
      ...
      int n = await generateIconSet(png, customSet, out: './sub');
    ...
    test('Correctly outputs a custom set of sizes from PNG ', () async {
      ...
      int n = await generateIconSet(png, customSet);
      expect(n, equals(customSet.length));
